...
export const INITIAL_TRAINS: Train[] = [
  {
    ...
    destinationCode: 'HWH',
    currentLocation: 'Howrah Junction',
    currentLocationCode: 'HWH',
    nextStation: 'Destination Arrived',
    nextStationCode: 'HWH',
    currentSpeed: 0,
    maxSpeed: 130,
    distanceCovered: 1447,
    totalDistance: 1447,
    scheduledEta: '12:15',
    traditionalEta: '12:15',
    ...
    timeline: [
      ...
      },
      {
        ...
        predictedArrival: '21:30',
        predictedDeparture: '21:35',
        delayMinutes: 0,
      ...
      },
      {
        ...
        predictedArrival: '23:40',
        predictedDeparture: '23:42',
        delayMinutes: 0,
      ...
      },
      {
        ...
        predictedArrival: '05:35',
        predictedDeparture: '05:38',
        delayMinutes: 0,
      ...
      },
      {
        ...
        predictedArrival: '08:40',
        predictedDeparture: '08:45',
        delayMinutes: 0,
      ...
      },
      {
        ...
        predictedArrival: '12:15',
        predictedDeparture: '12:15',
        delayMinutes: 0,
    ...
    delayFactors: [
      {
        id: 'df-1',
        name: 'Terminal Arrival Completed',
        category: 'recovery',
        impactMinutes: 0,
        type: 'gain',
        icon: '🏁',
        description: 'Train arrived safely at final destination (Howrah Junction)'
      }
    ]
  },
  {
    ...
    timeline: [
      ...
      },
      {
        ...
        predictedArrival: '19:43',
        predictedDeparture: '19:48',
        delayMinutes: 0,
      ...
      },
      {
        ...
        predictedArrival: '21:16',
        predictedDeparture: '21:26',
        delayMinutes: 0,
      ...
      },
      {
        ...
        predictedArrival: '03:15',
        predictedDeparture: '03:25',
        delayMinutes: 0,
    ...
    delayFactors: [
      {
        ...
        type: 'gain',
        icon: '🟢',
        description: 'Train scheduled for 17:00 departure from Mumbai Central'
      }
    ]
  },
  {
    ...
    currentLocation: 'Bina Junction',
    currentLocationCode: 'BINA',
    nextStation: 'Rani Kamlapati',
    ...
    timeline: [
      ...
      {
        id: 'b4',
        stationName: 'Bina Junction',
        stationCode: 'BINA',
        scheduledArrival: '12:35',
        scheduledDeparture: '12:37',
        predictedArrival: '12:35',
        predictedDeparture: '12:37',
        delayMinutes: 0,
        distanceFromOrigin: 562,
        status: 'current',
        platform: 'PF 2'
      },
      {
    ...
    delayFactors: [
      {
        id: 'b-df1',
        name: 'Optimal Section Clearance',
        category: 'recovery',
        impactMinutes: 0,
        type: 'gain',
        icon: '🟢',
        description: 'Maximum speed 130 km/h maintained with green signal aspects'
      }
    ]
  },
  {
    ...
    destination: 'New Delhi',
    destinationCode: 'NDLS',
    currentLocation: 'Rajendra Nagar Terminal',
    currentLocationCode: 'RJPB',
    nextStation: 'Patna Junction',
    nextStationCode: 'PNBE',
    currentSpeed: 0,
    maxSpeed: 130,
    distanceCovered: 0,
    totalDistance: 1002,
    scheduledEta: '07:40',
    traditionalEta: '07:40',
    aiPredictedEta: '07:40',
    delayMinutes: 0,
    status: 'not_started',
    confidenceScore: 98,
    lat: 41,
    ...
    timeline: [
      ...
      },
      {
        ...
        predictedArrival: '22:12',
        predictedDeparture: '22:22',
        delayMinutes: 0,
      ...
      },
      {
        ...
        predictedArrival: '07:40',
        predictedDeparture: '07:40',
        delayMinutes: 0,
    ...
    delayFactors: [
      {
        id: 'p-df1',
        name: 'Scheduled Evening Departure',
        category: 'recovery',
        impactMinutes: 0,
        type: 'gain',
        icon: '🟢',
        description: 'Scheduled departure at 19:10 from Rajendra Nagar Terminal'
      }
    ]
  },
  {
    ...
    destinationCode: 'BSB',
    currentLocation: 'Jhusi (near Prayagraj)',
    currentLocationCode: 'JI',
    ...
    timeline: [
      ...
      },
      {
        ...
        predictedArrival: '10:18',
        predictedDeparture: '10:20',
        delayMinutes: 10,
        distanceFromOrigin: 440,
        status: 'completed',
        platform: 'PF 5'
      },
      {
        ...
        predictedArrival: '12:24',
        predictedDeparture: '12:26',
        delayMinutes: 16,
        distanceFromOrigin: 635,
        status: 'completed',
        platform: 'PF 6'
      },
      {
        ...
        predictedArrival: '14:18',
        predictedDeparture: '14:18',
        delayMinutes: 18,
    ...
    delayFactors: [
      {
        id: 'v-df1',
        name: 'Downstream Section Congestion',
        category: 'congestion',
        impactMinutes: 12,
        type: 'delay',
        icon: '🔴',
        description: 'Single line crossover wait near Prayagraj junction'
      },
      {
        id: 'v-df2',
        name: 'Speed Restriction Zone (TSR)',
        category: 'speed_restriction',
        impactMinutes: 6,
        type: 'delay',
        icon: '🟠',
        description: 'Caution order 45 km/h over Ganges bridge approach'
      }
    ]
  },
  {
    ...
    currentLocation: 'Bikaner Junction',
    currentLocationCode: 'BKN',
    nextStation: 'Churu Junction',
    nextStationCode: 'CUR',
    currentSpeed: 0,
    maxSpeed: 130,
    distanceCovered: 0,
    totalDistance: 1918,
    scheduledEta: '12:45',
    traditionalEta: '12:45',
    aiPredictedEta: '12:45',
    delayMinutes: 0,
    status: 'not_started',
    confidenceScore: 98,
    lat: 48,
    ...
    timeline: [
      ...
      },
      {
        ...
        predictedArrival: '09:10',
        predictedDeparture: '09:15',
        delayMinutes: 0,
        distanceFromOrigin: 1690,
        status: 'upcoming'
      },
      {
        id: 'd4',
        ...
        predictedArrival: '12:45',
        predictedDeparture: '12:45',
        delayMinutes: 0,
        distanceFromOrigin: 1918,
        status: 'upcoming'
      }
    ],
    delayFactors: [
      {
        id: 'd-df1',
        name: 'Scheduled Evening Run',
        category: 'recovery',
        impactMinutes: 0,
        type: 'gain',
        icon: '🟢',
        description: 'Scheduled departure at 17:00 from Bikaner Junction'
      }
    ]
  }
];
